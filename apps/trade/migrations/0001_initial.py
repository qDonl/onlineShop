    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, max_length=100, null=True, verbose_name='收货地址')),
                ('signer_name', models.CharField(blank=True, max_length=20, null=True, verbose_name='签收人')),
