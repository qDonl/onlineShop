    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_sn', models.CharField(blank=True, max_length=50, null=True, verbose_name='商品唯一货号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加事件')),
                ('name', models.CharField(blank=True, max_length=30, null=True, verbose_name='类别名')),
                ('code', models.CharField(blank=True, max_length=30, null=True, verbose_name='类别code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加事件')),
                ('keywords', models.CharField(blank=True, max_length=20, null=True, verbose_name='热搜词')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加事件')),
                ('name', models.CharField(blank=True, max_length=30, null=True, verbose_name='品牌名')),
                ('desc', models.TextField(blank=True, help_text='品牌描述', max_length=200, null=True, verbose_name='品牌描述')),
